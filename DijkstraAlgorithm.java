package edu.ulima.redes.algoritmo;
import java.util.*;
public class DijkstraAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        E = sc.nextInt();
        System.out.println("Ingrese el origen ,  destino y peso de cada arista :");
...
class Dijkstra{
    ...
    void dijkstra( int inicial ){
        ...
        System.out.printf( "Distancias mas cortas cuando se inicia en el vertice %d\n" , inicial );
        for( int i = 1 ; i <= V ; ++i ){
            System.out.printf("V  %d , distancia mas corta = %d\n" , i , distancia[ i ] );
        }
    ...
    void printShortestPath(){
        ...
        Scanner sc = new Scanner( System.in );      //para lectura de datos
        System.out.println("\n________________Impresion de camino mas corto________________");
        System.out.printf("Ingrese el vertice destino: ");
        int destino;
        destino = sc.nextInt();
        print( destino );
        System.out.printf("\n");
